...
public class TextDiagnosticReportFormatterTests
{
    ...
    public void Format_IncludesTitleMarkersAndSummary()
    {
        ...
        [
            ...
            new DiagnosticCheckResult("connection", DiagnosticStatus.Warn, "Connection: WARN — /api/families svarade med 503")
        ]);
        ...
        Assert.Contains("[WARN] Connection: WARN — /api/families svarade med 503", text);
